...
pixels = [4, 11, 3] #best kernel dimension for the opening per dataset
alpha = [2.89, 3.2, 3.55] #best alpha per dataset (adaptative model)
rho = [0.21, 0.05, 0.16] #best rho per dataset (adaptative model)
